...
export default function Aboutme() {
    return (
        ...
        <p className="">
            ...
            As I have proficiency with technical system analysis, I have assisted many teams to resolve major issues and ensure software realaseas with the highest statndard of quality possible with respect CICD oriented SDLCs.
